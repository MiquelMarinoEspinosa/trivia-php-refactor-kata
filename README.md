...
- Now that the visibility of some methods at `GameCalculator` has been reduced, it can easily be detected which ones are used not many times which deserves to have its own class and `inline` them
